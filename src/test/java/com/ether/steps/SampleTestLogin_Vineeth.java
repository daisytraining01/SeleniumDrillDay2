...
public class SampleTestLogin_Vineeth {
	...
	public void user_clicks_on_delete_button() throws Throwable {
		...
		SeleniumDriver.getDriver().findElement(By.xpath("//tr[5]//td[6]//a[1]]")).click();
		Thread.sleep(3000);
	    
	}

	@Then("^verify Recipient is deleted$")
	public void verify_Recipient_is_deleted() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
		boolean d=SeleniumDriver.getDriver().findElement(By.xpath("//tr[5]//td[1]//a[1]]")).isDisplayed();
		if(d==true)
		{
			Assert.fail();
		}
